<?php
/**
 * ModernStoreTheme functions and definitions
 *
...
function mst_setup() {
	/*
		...
		* If you're building a theme based on ModernStoreTheme, use a find and replace
...
function mst_scripts() {
	...
	wp_style_add_data( 'mst-style', 'rtl', 'replace' );

	wp_enqueue_script( 'mst-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
